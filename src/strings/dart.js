...
function solution(dartResult) {
        ...
        switch (scoreMap.get('option')) {
            case '*':        
                ...
                if (idx === 0) {
                    ...
                    scoreMapArr[idx-1].set('scores', scoreMapArr[idx-1].get('scores') * 2)              
                }   
                break
    ...
    const finalScore =  scoreMapArr[0].get('scores') +  scoreMapArr[1].get('scores') + scoreMapArr[2].get('scores')
    return finalScore
}